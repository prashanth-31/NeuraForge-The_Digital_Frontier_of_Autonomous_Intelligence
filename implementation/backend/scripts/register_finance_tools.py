"""Register finance MCP tools against the configured MCP router.

Usage:
    E:/NeuraForge-The_Digital_Frontier_of_Autonomous_Intelligence/implementation/backend/.venv/Scripts/python.exe scripts/register_finance_tools.py
...
from app.services.tool_onboarding import FINANCE_TOOLS

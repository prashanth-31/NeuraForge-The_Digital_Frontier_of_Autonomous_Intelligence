...
try:  # pragma: no cover - import resolution
    import jwt as _jwt_backend
    _jwt_encode = _jwt_backend.encode
    _jwt_decode = _jwt_backend.decode
    _jwt_error = _jwt_backend.PyJWTError
except (AttributeError, ImportError):  # pragma: no cover - fallback path
    from jose import jwt as _jwt_backend  # type: ignore[assignment]
    from jose.exceptions import JWTError as _jwt_error  # type: ignore[assignment]
...
def decode_access_token(token: str) -> dict[str, Any]:
    ...
    except _jwt_error as exc:  # pragma: no cover - error path covered by HTTPException
        raise HTTPException(
